...
const ProductListTable = ({product}) => {
    const {Description,category,name,newPrice,oldPrice,offerPrice,quantity,brand,_id,image }=product;
    console.log(product)
...
//  console.log(data)
    ...
    return (
      ...
      <td>{category}</td>
      <td >
   <Link to ={`/updateProduct/${product._id}`}><span><AiFillEdit ></AiFillEdit>Edit   </span></Link>
