...
const HeaderToper = () => {
  ...
  return (
    <div className=" bg-[#006FBA] text-white py-1">
      <div className="navbar max-w-screen-2xl mx-auto ">
        ...
        <NavLink to="/profile" className="ml-5">
          {profile?._id && (
            <div className="flex justify-center items-center gap-2  mr-3">
              ...
              <NavLink to="/profile" className=" min-w-max">
                {profile?.name}
              </NavLink>
            </div>
          )}
        ...
        {profile?.isAdmin && profile?.role === "admin" && (
          <div className="ml-4 bg-[#008A5F] rounded p-2">
      ...
      <div className=" max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 z-30"></div>
    </div>
  );
};
